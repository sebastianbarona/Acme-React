...
<div className="col-md-6 col-7 content_section"> 
    <div> 
        ...
        <p> Bienvenido a Cacharrerias Don Andres recuerde llenar muy bien los campos antes de Modificar un Intermediario </p>
        <br></br>
    </div>
    <div className="row justify-content-center">
        <div className="mt75 row justify-content-center">                                      
            ...
            <div >
            <center>  
                <label colSpan={3}>No Hay Intermediarios</label>
            </center>
            </div>
                )
                }
